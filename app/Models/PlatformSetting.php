...
class PlatformSetting extends Model
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'bible.provider' => [
                'value' => env('BIBLE_PROVIDER', 'bible_api_com'),
                'type' => 'string',
                'group' => 'Bible API',
                'label' => 'Daily scripture provider',
                'description' => 'External provider used when syncing the daily scripture.',
            ],
            'bible.default_translation' => [
                'value' => env('BIBLE_DEFAULT_TRANSLATION', 'web'),
                'type' => 'string',
                'group' => 'Bible API',
                'label' => 'Default translation',
                'description' => 'Preferred translation for providers that support translation choices.',
            ],
            'bible.our_manna_enabled' => [
                'value' => filter_var(env('OUR_MANNA_ENABLED', true), FILTER_VALIDATE_BOOLEAN) ? '1' : '0',
                'type' => 'boolean',
                'group' => 'Bible API',
                'label' => 'Our Manna fallback',
                'description' => 'Allow Our Manna as an optional verse-of-the-day provider.',
            ],
            'bible.api_bible_enabled' => [
                'value' => env('API_BIBLE_KEY') && env('API_BIBLE_ID') ? '1' : '0',
                'type' => 'boolean',
                'group' => 'Bible API',
                'label' => 'API.Bible fallback',
                'description' => 'Allow API.Bible when API_BIBLE_KEY and API_BIBLE_ID are configured.',
            ],
