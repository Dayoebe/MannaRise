...
class DailySpiritualRhythm
{
    ...
    private const FALLBACK_SCRIPTURES = [
     ...
     */
    public static function fallbackScriptureForTheme(string $theme): array
    {
        return self::FALLBACK_SCRIPTURES[$theme] ?? self::FALLBACK_SCRIPTURES['peace'];
    }
