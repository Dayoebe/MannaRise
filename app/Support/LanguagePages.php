...
class LanguagePages
{
    private const LANGUAGES = [
        'en' => [
            ...
            'invite_prayer' => 'Invite someone to pray with you today',
        ...
        'fr' => [
            ...
            'invite_prayer' => 'Inviter quelqu’un à prier avec vous',
        ...
        'es' => [
            ...
            'invite_prayer' => 'Invitar a alguien a orar contigo',
        ...
        'pt' => [
            ...
            'invite_prayer' => 'Convidar alguém para orar com você',
        ...
        'sw' => [
            ...
            'invite_prayer' => 'Mwalike mtu aombe pamoja nawe',
        ...
        'yo' => [
            ...
            'device_share' => 'Pín',
            'invite_prayer' => 'Pe ẹnikan láti gbàdúrà pẹ̀lú rẹ',
        ...
        'ha' => [
            ...
            'device_share' => 'Raba',
            'invite_prayer' => 'Gayyaci wani ya yi addu’a tare da kai',
        ...
        'ig' => [
            ...
            'device_share' => 'Kesaa',
            'invite_prayer' => 'Kpọọ mmadụ ka ọ kpee ekpere gị na ya',
    ...
    public static function dailyCopy(string $locale, array $dailyRhythm, CarbonInterface $date): array
    {
        ...
        return [
            ...
            'invite_prayer' => $language['invite_prayer'],
