...
use App\Livewire\Daily\Show as DailyShow;
...
use App\Livewire\Pages\LocalizedHome;
...
Route::get('/{locale}', LocalizedHome::class)->where('locale', LanguagePages::routePattern())->name('localized.home');
...
Route::get('/pray-together/{token}', PrayerPartnerShow::class)->where('token', '[A-Za-z0-9_-]{10,80}')->name('prayer-partners.show');
