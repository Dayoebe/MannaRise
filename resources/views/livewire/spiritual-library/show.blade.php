    ...
    <article class="app-panel overflow-hidden border-olive-200 bg-white p-0 sm:p-0">
        @if ($currentChapter)
            ...
            <div class="flex flex-col gap-4 p-5 sm:flex-row sm:items-start sm:justify-between sm:p-8">
                <div>
                    <p class="inline-flex items-center gap-2 rounded-full border border-olive-200 bg-olive-50 px-3 py-1 text-sm font-black uppercase tracking-normal text-olive-800">🌿 Chapter {{ $currentChapter->chapter_number }}</p>
