    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        @forelse ($devotionals as $devotional)
            <article class="app-panel border-t-4 border-t-emerald-500 hover:border-emerald-300 even:border-t-lime-500">
                <p class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-bold uppercase tracking-normal text-emerald-900"><x-ui.icon name="bookmark" class="h-4 w-4" /> {{ $devotional->category?->name }}</p>
